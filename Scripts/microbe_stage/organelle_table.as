...
void setupOrganelles(){
    ...
    // ------------------------------------ //
	// steelSynthisizingProteins
    auto steelSynthisizingProtein = OrganelleParameters("steelSynthisizingProteins");

    steelSynthisizingProtein.mass = 0.1;
    steelSynthisizingProtein.gene = "z";
    steelSynthisizingProtein.mesh = "chemoproteins.mesh";
    steelSynthisizingProtein.chanceToCreate = 0.5f;
    steelSynthisizingProtein.prokaryoteChance = 1;
    steelSynthisizingProtein.mpCost = 45;
    steelSynthisizingProtein.initialComposition = {
        {"phosphates", 1},
        {"ammonia", 1}
    };
    steelSynthisizingProtein.components = {
        processorOrganelleFactory(1.0f),
        storageOrganelleFactory(20.0f)
    };
    steelSynthisizingProtein.processes = {
      TweakedProcess("steel_Synthesis", 1),
      TweakedProcess("glycolosis", 1)
    };
    steelSynthisizingProtein.hexes = {
        Int2(0, 0),
    };

    _addOrganelleToTable(Organelle(steelSynthisizingProtein));
	// ------------------------------------ //
