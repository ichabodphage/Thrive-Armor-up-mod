...
class MicrobeStageHudSystem : ScriptSystem{
    ...
    void Init(GameWorld@ world){
        ...
        this.ironVolume = SimulationParameters::compoundRegistry().getTypeData(
			...
			this.steelId = SimulationParameters::compoundRegistry().getTypeId("steel");
        this.steelVolume = SimulationParameters::compoundRegistry().getTypeData(
            this.steelId).volume;
    ...
    void Run(){
        ...
        if(player != NULL_OBJECT){
            ...
            if(bag is null){
				...
				const auto steelAmount = bag.getCompoundAmount(steelId);
                const auto maxsteel = microbeComponent.capacity;
				...
				vars.AddValue(ScriptSafeVariableBlock("compoundsteel", steelAmount));
                vars.AddValue(ScriptSafeVariableBlock("steelMax", maxsteel));
            }
