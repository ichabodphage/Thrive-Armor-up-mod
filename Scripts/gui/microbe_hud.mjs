...
export function runMicrobeHUDSetup(){
    ...
    if(common.isInEngine()){
        ...
        const steel = common.randomBetween(0, 50);
        updateMicrobeHUDBars({
            ...
            IronMax: iron,
            compoundsteel: common.randomBetween(0, steel),
            steelMax: steel,
        });
...
function updateMicrobeHUDBars(values){
    ...
    document.getElementById("microbeHUDPlayerIronBar").style.width =
        ...
        document.getElementById("microbeHUDPlayersteel").textContent =
            values.compoundsteel.toFixed(1);
        document.getElementById("microbeHUDPlayersteelMax").textContent =
            values.steelMax;
        document.getElementById("microbeHUDPlayersteelBar").style.width =
            common.barHelper(values.compoundsteel, values.steelMax);
